...
use bindings::exports::my_app::plugin::api::Guest as Api;
use bindings::exports::my_app::plugin::queries::Guest as Queries;
...
impl Api for MyAppPlugin {
    fn set_example_thing(thing: String) {
        let packed_example_thing_args = my_app::action_structs::setExampleThing { thing }.packed();
...
bindings::export!(MyAppPlugin with_types_in bindings);
