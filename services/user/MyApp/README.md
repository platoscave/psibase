...
This is an autogenerated README.md file for the "My App" app.
...
That's it! A package will be generated at `./target/wasm32-wasip1/release/packages/MyApp.psi`
...
The UI is served at the `my-app` subdomain of your local psinode network.
